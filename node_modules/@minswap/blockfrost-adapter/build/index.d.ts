...
declare class BlockfrostAdapter {
     ...
     */
    getPools({ page, count, order, poolAddress, }: GetPoolsParams): Promise<PoolState[]>;
    /**
...
declare const POOL_ADDRESS_LIST: {
    0: string[];
    1: string[];
};
declare const POOL_ADDRESS_SET: {
    0: Set<string>;
    1: Set<string>;
};
...
export { BlockfrostAdapter, BlockfrostAdapterOptions, FACTORY_ASSET_NAME, FACTORY_POLICY_ID, GetPoolByIdParams, GetPoolHistoryParams, GetPoolInTxParams, GetPoolPriceParams, GetPoolsParams, LP_POLICY_ID, NetworkId, ORDER_ADDRESS, POOL_ADDRESS_LIST, POOL_ADDRESS_SET, POOL_NFT_POLICY_ID, PoolState };
