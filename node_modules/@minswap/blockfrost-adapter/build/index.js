...
class PoolState {
  ...
  getAmountOut(assetIn, amountIn) {
    ...
    return {
      ...
      priceImpact: new Big__default["default"](priceImpactNumerator.toString()).mul(new Big__default["default"](100)).div(new Big__default["default"](priceImpactDenominator.toString()))
    };
  }
...
function checkValidPoolOutput(networkId, poolAddress, value, datumHash) {
  invariant__default["default"](POOL_ADDRESS_SET[networkId].has(poolAddress), `invalid pool address: ${poolAddress}`);
...
exports.POOL_ADDRESS_LIST = POOL_ADDRESS_LIST;
exports.POOL_ADDRESS_SET = POOL_ADDRESS_SET;
